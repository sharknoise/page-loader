...
# test with a real response first and then with a mock response
@pytest.mark.parametrize('response', [None, ct.mock_response200])
def test_download_page(response, tmp_path):
